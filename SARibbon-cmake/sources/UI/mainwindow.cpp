...
, m_customizeWidget(nullptr), sqlBrowser(nullptr)
{
	...
	QAction *browserAction = new QAction(QIcon(":/icon/icon/help.png"), "customize_2", this);
	quickAccessBar->addAction(browserAction);
	addSomeOtherAction();

	connect(browserAction, &QAction::triggered, this, [&]() {
		if (nullptr == sqlBrowser) {
			sqlBrowser = new Browser(this, this, Qt::WindowMinMaxButtonsHint | Qt::WindowCloseButtonHint | Qt::Dialog);
			sqlBrowser->setWindowModality(Qt::ApplicationModal);
			sqlBrowser->setAttribute(Qt::WA_ShowModal, true);
			//sqlBrowser->setupActionsManager(m_actMgr);
		}
		sqlBrowser->show();
		//sqlBrowser->applys();
	});
...
{
	QAction *acttext1 = new QAction(("action1"), this);
	QAction *acttext2 = new QAction(("action2"), this);
	QAction *acttext3 = new QAction(("action3"), this);
	QAction *acttext4 = new QAction(("action4"), this);
	QAction *acttext5 = new QAction(("action5"), this);
